...
void main() {
	const uint data = packed_mesh_data[gl_VertexID / 6];
	...
	vec3 local_pos = face_pos[gl_VertexID % 6];
...
// void main() {
// 	const int idx = gl_VertexID / 6;
// 	const uint data = packed_mesh_data[idx];
// 	const int cur_vert_id = gl_VertexID % 6;

// 	const uint x = bitfieldExtract(data, 0, 8);
// 	const uint y = bitfieldExtract(data, 8, 8);
// 	const uint z = bitfieldExtract(data, 16, 8);
// 	const uint face = bitfieldExtract(data, 24, 8);

// 	vec3 pos = vec3(x, y, z);
// 	pos += face_pos[idxs[cur_vert_id]];
